...
function TermsUses() {
  return (
    <div className="bg-gray-800 text-gray-100 xl:p-40 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">User Eligibility</h2>
          <p className="text-base md:text-lg">
        ...
        <section className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">Deposits and Withdrawals</h2>
          <p className="text-base md:text-lg">
        ...
        <section className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">Pricing and Market Determination</h2>
          <p className="text-base md:text-lg">
        ...
        <section className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">Admin and AI Agents</h2>
          <p className="text-base md:text-lg">
        ...
        <section className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">Legal Compliance</h2>
          <p className="text-base md:text-lg">
        ...
        <section className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4">Changes to Terms of Use</h2>
          <p className="text-base md:text-lg">
