...
export default function Portfolio() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-gray-800 py-20 px-8 text-gray-100">
      <div className="w-full max-w-5xl">
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-8 text-white">
            <Card className="w-72 rounded-lg bg-gradient-to-r from-sky-700 via-sky-600 to-sky-800 p-6 text-white">
              <CardHeader>
            ...
            <Card className="w-72 rounded-lg bg-gradient-to-r from-teal-500 to-blue-500 p-6 text-white">
              <CardHeader>
            ...
            <Table className="overflow-hidden rounded-lg border border-gray-600">
              <TableHeader>
                <TableRow className="bg-gray-700 font-semibold text-white">
                  <TableHead className="border border-gray-600 p-6 text-lg font-bold text-white">
                    Market
                  </TableHead>
                  <TableHead className="border border-gray-600 p-6 text-lg font-bold text-white">
                    Side
                ...
                {positions.length === 0 ? (
                  ...
                  positions.map((position, index) => (
                    <TableRow key={index} className="border border-gray-600">
                      <TableCell className="border border-gray-600 p-6">
                        {position.market}
                      </TableCell>
                      <TableCell className="border border-gray-600 p-6">
                        {position.side}
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          ...
          <DialogDescription>
            {/* Add content for Deposit/Withdraw */}
            <Input type="number" placeholder={`Amount to ${modalType}`} />
          </DialogDescription>
